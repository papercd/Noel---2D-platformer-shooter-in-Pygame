...
class HealthBar(Bar):
    ...
    def update(self,health):
        ...
        if self.mid_cur > self.cur_resource:
            self.mid_cur -= 2*(self.mid_cur-self.cur_resource )/5
        if self.last_cur > self.cur_resource:
            self.last_cur -= (self.last_cur-self.cur_resource )/5
    ...
    def render(self,surf,offset = (0,0)):
        ...
        pygame.draw.rect(surf,(173,106,29,255),(self.x-offset[0],self.y-offset[1],self.w*ratio_last,self.h))
        pygame.draw.rect(surf,(225,69,29,255),(self.x-offset[0],self.y-offset[1],self.w*ratio_mid,self.h))
